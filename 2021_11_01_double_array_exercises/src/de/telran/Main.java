...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] unsortedArray = new int[]{12, -8, 5, 17, -21, 25};
    ...
    //Есть двумерный массив. Вернуть одномерный массив, содержащий суммы подмассивов первого массива, у которых есть
    // положительные элементы. (см 3 задача предыдущего ДЗ)
    ...
    static void selectionSort(int[] array) {
        for (int i = 0; i < array.length; i++) {
            int minIndex = 1;
            //search for the index of the min element of the rest of unsorted elements being not on it's place
            ...
            // swap the min with the i-th element (placing the element onto its place)
